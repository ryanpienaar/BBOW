...
crs_utm <- 32615  # UTM zone 15N

# Convert UTM to lat long with correct coordinate order
dfutmsf <- st_as_sf(NPScanopy_proportion, coords = c("Easting", "Northing"), crs = crs_utm)
